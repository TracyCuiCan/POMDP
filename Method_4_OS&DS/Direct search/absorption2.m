...
% a specific bound for two decision makers.

function value = absorption2(bound)
% These transition matrices are computed once in fmin2.m to speed the computation
global trans1 trans10 trans11 trans2 trans20 trans21 C
