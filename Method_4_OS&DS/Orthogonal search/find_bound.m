%This function is part of orthogonal search, it has three input, P is the conditionaly probability of
...
%true; C(3) is the continue cost. P_u is the return from absorption.m
% It returns the thresholds found by value iteration.
