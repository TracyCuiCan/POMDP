...
Discretise0.m and Discretise1.m returns the discretized grids for a continuous states given certain problem, where Discretise0.m follows the zeroth-order discretization and Discretise1.m follows the first-order discretization.
